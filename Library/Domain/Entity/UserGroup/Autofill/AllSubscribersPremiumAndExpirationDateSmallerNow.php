...
class UserGroup_Autofill_AllSubscribersPremiumAndExpirationDateSmallerNow extends UserGroup_Autofill
{
    public function fill()
    {
        $result = array();

        $aModelParams = array('expiration_date' => '< NOW()', 'person_type_id' => 4, 'subscribe_plan_name' => 'premium');
        ...
        $oModel = new \Domain\Model\User(array('subscribe_end_date' => '< NOW()', 'snob_person_type' => array('premium', 'partner'), 'noorder' => 1));
        $oCollection = $oModel->getCollection('list');
